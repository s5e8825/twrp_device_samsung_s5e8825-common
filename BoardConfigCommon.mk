...
TARGET_PREBUILT_KERNEL := $(KERNEL_PREBUILT_PATH)/Image
TARGET_PREBUILT_DTB := $(KERNEL_PREBUILT_PATH)/dtb
BOARD_INCLUDE_RECOVERY_DTBO := true
BOARD_PREBUILT_DTBOIMAGE := $(KERNEL_PREBUILT_PATH)/dtbo/$(DEVICE_CODENAME)/dtbo.img
...
BOARD_CUSTOM_BOOTIMG_MK := $(COMMON_PATH)/AndroidBoard.mk
